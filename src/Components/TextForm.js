  ...
  return (
    <>
        ...
        <div className='container my2' style={{color: ((props.mode!=='light' && props.mode!=='yellow' && props.mode!=='cyan')?'white':'#08175b')}}>
            ...
            <p>{1/125 * text.split(" ").filter((element)=>{return element.length!==0}).length} minutes or {1/125*60 * text.split(" ").filter((element)=>{return element.length!==0}).length} seconds</p>
            <h4>Preview:</h4>
